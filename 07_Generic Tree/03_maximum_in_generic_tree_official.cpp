...
// function to maximum in generic tree
int maximumInGenericTree(Node* node){
	...
	for(int i=0; i<node->children.size(); i++){
		...
		// calculate max for child and compare with parent
		int mfc = maximumInGenericTree(child);
...
int main(){
	...
	cout << maximumInGenericTree(root);
